...
public class MyCharacter extends CustomPlayer {
    ...
    private static final CharacterStrings characterStrings = CardCrawlGame.languagePack.getCharacterString(MyUtil.makeCharId(MyCharacter.class.getSimpleName()));

    private static final String CharacterImg = ImgHelper.getCharPath("character.png");
    public MyCharacter(String name) {
        super(name, Enums.MY_CHARACTER, ORB_TEXTURES, VFX_IMAGE, LAYER_SPEED, null, null);
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add(MyUtil.makeCardId("Strike"));
        retVal.add(MyUtil.makeCardId("Power"));
        return retVal;
    }
